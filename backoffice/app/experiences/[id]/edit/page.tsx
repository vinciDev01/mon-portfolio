...
export default function EditExperiencePage() {
  ...
  useEffect(() => {
    fetchEntity<ExperienceDto>("experiences", id).then((d) => {
      setCompany(d.company); setRole(d.role); setDescription(d.description || "");
      setStartDate(d.startDate.substring(0, 10)); setEndDate(d.endDate ? d.endDate.substring(0, 10) : "");
      setIsCurrent(d.isCurrent); setSortOrder(d.sortOrder);
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      await updateEntity("experiences", id, {
  ...
  return (
    <div className="max-w-lg">
      <h1 className="text-2xl font-bold mb-8">Modifier l&apos;expérience</h1>
